...
namespace JitbitSoftware.VSUnusedImg
{
	...
	[Guid(GuidList.guidVSUnusedImgPkgString)]
	public sealed class VSUnusedImgPackage : Package
	{
		...
		protected override void Initialize()
		{
			...
			if ( null != mcs )
			{
				...
				CommandID menuCommandID = new CommandID(GuidList.guidVSUnusedImgCmdSet, (int)PkgCmdIDList.cmdidFindImgs);
		...
		private ProjectItem GetProjectItemsRecursive(ProjectItem item)
		{
			//base case
			...
			while (items.MoveNext())
			{
				...
				_projectItems.Add(GetProjectItemsRecursive(currentItem));
			}
